@foreach($apps as $app)
    ...
    <div class="row" style="margin-top: 1em;">
        ...
        <div class="col-xl-2 col-3">
        @if($app->changelog()->orderBy('created_at', 'desc')->first() && ($app->changelog()->orderBy('created_at', 'desc')->first()->new_state == \App\Models\Application::ON_HOLD || $app->changelog()->orderBy('created_at', 'desc')->first()->new_state == \App\Models\Application::TRIAL))
